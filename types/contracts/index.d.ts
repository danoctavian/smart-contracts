...
export interface IPool1Contract extends Truffle.Contract<IPool1Instance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<IPool1Instance>;
}
...
export interface NexusMemberContract
  extends Truffle.Contract<NexusMemberInstance> {
  "new"(
    _nxMaster: string | BigNumber,
    meta?: Truffle.TransactionDetails
  ): Promise<NexusMemberInstance>;
}
...
export interface IPool1Instance extends Truffle.ContractInstance {
  buyToken: {
    (txDetails?: Truffle.TransactionDetails): Promise<
      Truffle.TransactionResponse
    >;
...
export interface NexusMemberInstance extends Truffle.ContractInstance {
  buyNXMTokens: {
    (
